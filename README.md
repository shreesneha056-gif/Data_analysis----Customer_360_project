...
> [!IMPORTANT]
> The final compiled analytics profiles, engineered feature metrics, and buyer indicators generated by this pipeline are explicitly exported and preserved inside the production spreadsheet asset:
> **`active_buyers_ans.xlsx`** (or saved in CSV format as `active_buyers_ans.csv`).
